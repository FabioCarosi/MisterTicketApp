                    ...
                    <div class="container">
                        ...
                        <div id="navbar-collapse-02" class="collapse navbar-collapse">
                            <ul class="nav navbar-nav navbar-right">
                                <li class="propClone"><a href="catalog.html">Eventi</a></li>
                                ...
                                <li class="propClone"><a href="registration.html">Registrati</a></li>
                                <li class="propClone" style="display: none"><a href="logout.html">Logout</a></li>
            ...
            <div class="container toparea">
                <div class="underlined-title">
                    <div class="editContent">
                        <h1 class="text-center latestitems">Nome Evento</h1>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="#checkout.html" class="btn btn-buynow">$49.00 - Acquista</a>
                        <div class="properties-box">
                            <ul class="unstyle ">
                                <li><b class="propertyname">Data:</b> 1.0</li>
                                <li><b class="propertyname">Ora:</b> 2340x1200</li>
                                <li><b class="propertyname">Posto:</b> mp3, audio, jpeg, png</li>
                                <li><b class="propertyname">Organizzatore:</b> Well Documented</li>
